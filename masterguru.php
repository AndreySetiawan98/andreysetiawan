<?php
include 'koneksi.php';
$guru = mysqli_query($kon, "SELECT id, foto, nama, nip  FROM tbl_guru");
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Master Guru</h6>
                                ...
                                <table class="table table-striped table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach( $guru as $row ) : ?>
                                        <tr align="center">
                                            ...
                                            <td><?= $row['nip'] ?></td>
                                            <td>
                                                <a class="edit" title="edit" href="editguru.php?id=<?= $row['id']; ?>"><i class="fas fa-pencil-alt"></i></a>|
                                                <a class="detail" title="detail" href="detailguru.php?id=<?= $row['id']; ?>"><i class="fas fa-info"></i></a> |
                                                <a class="delete" title="Hapus" href="#modalDelete" onclick="$('#modalDelete #formDelete').attr('action','hapusguru.php?id=<?= $row['id']; ?>')" 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="tambahguru.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <span class="star">*</span>
            <input type="text" class="form-control" id="mp" name="matpel" autocomplete="off" required>
        </div>
        <div class="form-group">
