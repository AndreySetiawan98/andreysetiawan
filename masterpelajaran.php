<?php
include 'koneksi.php';
$mp = mysqli_query($kon, "SELECT * FROM tbl_pelajaran");
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Master Mata Pelajaran</h6>
                                ...
                                <table class="table table-striped table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach( $mp as $row ) : ?>
                                        <tr align="center">
                                            ...
                                            <td>
                                                <a class="edit" title="edit" href="editpelajaran.php?id=<?= $row['id']; ?>"><i class="fas fa-pencil-alt"></i></a> |
                                                <a class="delete" title="Hapus" href="#modalDelete" onclick="$('#modalDelete #formDelete').attr('action','hapuspelajaran.php?id=<?= $row['id']; ?>')" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Form Tambah Mata Pelajaran</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="tambahpelajaran.php" method="post" enctype="multipart/form-data">
      <div class="modal-body">
      <span class="star">* Field Wajib Diisi</span><br><br>
      <div class="form-group">
            <label class="control-label" for="matpel">Mata Pelajaran</label>
