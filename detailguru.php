        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- DataTales Example -->
                    <?php 
                         $row = mysqli_query($kon, "SELECT * FROM tbl_guru WHERE id='$id'");
                         while($p = mysqli_fetch_assoc($row)){
                    ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Detail Data Guru</h6>
                            <a class="btn btn-success float-right" href="cetakguru.php?id=<?= $p['id']; ?>" role="button"><i class="far fa-file-pdf"></i> Cetak</a>
                        </div>
                    <?php
                         }
                    ?>
                            ...
                            <div class="table-responsive">
                                <table border="0" id="example" width="50%" cellpadding="8">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><button class="btn btn-primary" formaction="header.php?role=guru" type="submit" name="kembali">KEMBALI</button></td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach; ?>
                                    </form>
