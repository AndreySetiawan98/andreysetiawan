                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table border="0" id="example" width="50%" cellpadding="8">
                                    <form action="ubahwali.php" method="POST" enctype="multipart/form-data">
                                    <?php while($row = mysqli_fetch_array($wali)) : ?>
                                    <tbody>
                                        <input type="hidden" name="id" value="<?= $row['id']; ?>" required>
                                        <tr>
                                            <td>Nama</td>
                                            <td>:</td>
                                            <td><input type="text" name="nama" size="30" value="<?= $row['nama_wali']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>NIP</td>
                                            <td>:</td>
                                        ...
                                        <tr>
                                            <td>Wali Kelas</td>
                                            <td>:</td>
                                            <td><input type="text" name="wakel" size="30" value="<?= $row['walikelas']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Status Kerja</td>
                                            <td>:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary" formaction="header.php?role=walikelas" type="submit">KEMBALI</button></td>
                                        </tr>
                                    </tbody>
                                    <?php endwhile; ?>
                                    </form>
