...
$hapus = "DELETE FROM tbl_wali WHERE id='$id'";
...
$hasil = "SELECT * FROM tbl_wali ORDER BY id = '$id'";
...
while($row = mysqli_fetch_array($ubah)){
    ...
    // proses update data
    $update = "UPDATE tbl_wali SET id = $no WHERE id = '$id'";
...
$query = "ALTER TABLE tbl_wali AUTO_INCREMENT = $no";
