<?php
include 'koneksi.php';
$wali = mysqli_query($kon, "SELECT * FROM tbl_wali");
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Master Wali Kelas</h6>
                                ...
                                <table class="table table-striped table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach( $wali as $row ) : ?>
                                        <tr align="center">
                                            ...
                                            <td><?= $row['walikelas'] ?></td>
                                            <td>
                                                <a class="edit" title="edit" href="editwali.php?id=<?= $row['id']; ?>"><i class="fas fa-pencil-alt"></i></a>|
                                                <a class="detail" title="detail" href="detailwali.php?id=<?= $row['id']; ?>"><i class="fas fa-info"></i></a> |
                                                <a class="delete" title="Hapus" href="#modalDelete" onclick="$('#modalDelete #formDelete').attr('action','hapuswali.php?id=<?= $row['id']; ?>')" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Form Tambah Wali Kelas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="tambahwali.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <span class="star">*</span>
            <input type="text" class="form-control" id="agama" name="agama" autocomplete="off" required>
        </div>
        <div class="form-group">
            <label for="wakel">Wali Kelas</label>
            <span class="star">*</span>
            <select class="custom-select" id="wakel" name="wakel" autocomplete="off" required>
                <option value="">Pilih..</option>
