...
$id = $_GET['id'];
$tahun = mysqli_query($kon, "SELECT * FROM tbl_tahun WHERE id='$id'") or die(mysql_error());
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Tahun Pelajaran</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table border="0" id="example" width="20%" cellpadding="8">
                                    <form action="ubahtahun.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><input type="number" name="tahun" size="20" value="<?= $row['id_tahun']; ?>" autocomplete="off" 
                                            required></td>
                                        </tr>
                                        <tr>
                                            <td><button class="btn btn-success" type="submit" name="simpan">SIMPAN</button></td>
                                            <td><button class="btn btn-primary" formaction="header.php?role=tahun" type="submit">KEMBALI</button></td>
                                        </tr>
                                    </tbody>
                                    <?php endwhile; ?>
                                    </form>
