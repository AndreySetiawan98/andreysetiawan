...
$id = $_GET['id'];
$guru = mysqli_query($kon, "SELECT * FROM tbl_guru WHERE id='$id'") or die(mysql_error());
                                ...
                                <table border="0" id="example" width="50%" cellpadding="8">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Nama</td>
                                            <td>:</td>
                                            <td><input type="text" name="nama" size="30" value="<?= $row['nama']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>NIP</td>
                                            <td>:</td>
                                            <td><input type="text" name="nip" size="30" value="<?= $row['nip']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Alamat</td>
                                            <td>:</td>
                                            <td><input type="text" name="alamat" size="30" value="<?= $row['alamat']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Jenis Kelamin</td>
                                            <td>:</td>
                                            <td><input type="text" name="jenis" size="30" value="<?= $row['jkl']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Agama</td>
                                            <td>:</td>
                                            <td><input type="text" name="agama" size="30" value="<?= $row['agama']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Mata Pelajaran</td>
                                            <td>:</td>
                                            <td><input type="text" name="matpel" size="30" value="<?= $row['matpel']; ?>" required></td>
                                        </tr>
                                        <tr>
                                            <td>Status Kerja</td>
                                            <td>:</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary" formaction="header.php?role=guru" type="submit">KEMBALI</button></td>
                                        </tr>
                                    </tbody>
                                    <?php endwhile; ?>
                                    </form>
...
<script>
        const status = "<?= ($row['status']=='aktif') ? 'success' : 'danger'?>"
        $('#btn').css(btn btn-${status})
    </script>
</body>
</html>
